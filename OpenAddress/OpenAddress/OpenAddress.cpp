...
Open addressing to solve collisions.
This program is an implemention of open addressing,. Included three hash function:
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	clock_t start;
	clock_t finish;
	cout<<"----This is open addressing hashing. First of all, choose the hash function-----Follow the description"<<endl;
	cout<<"division:           enter 1"<<endl;
	cout<<"middle square:      enter 2"<<endl;
	cout<<"fibonacci: enter 3"<<endl;
	cin>>index;
/**following is the auto insert part, randomly choose some numbers to insert to the hash table ***/	
	...
	if(i==1)
	{
		...
		cout<<endl;
		h.printTable("Open Address table.txt");      // save the hash table in Open addressing Table.txt
		cout<<endl;
	}

	cout<<"following is the manual search/delet/insert part ,in each part you can input 5 numbers."<<endl;
	...
	for(int j = 0; j< 5 ; j++){
	  cin>>insert;
	  if(h.Insert(insert,index)) cout<<"insert succeeded";
	  else cout<<"failed";
	  cout<<endl;
	}
	h.printTable("Open Address table.txt");
	}
	...
	for(int j = 0; j< 5 ; j++){
	 ...
	 else 
	 {
	  finish = clock();
	  double time = (double)(finish - start);
	  cout << "failed.  time is  " << time <<"ms"<<endl;
	  }
	}
	}
	...
	if(j==1)
	{
		...
		h1.printTable("Open address division.txt");      // save the hash table 
		h2.printTable("Open address middle.txt");      // save the hash table 
		h3.printTable("Open address fibonacci.txt");      // save the hash table 
	}
